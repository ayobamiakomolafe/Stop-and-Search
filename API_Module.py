...
def data_extraction():
    ...
    is for the month of October 2021, hence we set date params as 2021-10"""
    ...
    'we loop through each of the force_id and collect their stop and search by force data for the month of OCTOBER'
